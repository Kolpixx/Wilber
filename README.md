...
Contributions are always welcome! To add a new theme you can head to the [consts.ts](./src/consts.ts) file, add the identifier and display name `(["IDENTIFIER", "DISPLAY_NAME"])` to the themes Array and set your custom css rules in the [themes.css](./src/themes.css) file.
